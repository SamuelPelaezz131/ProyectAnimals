          ...
          <div class="bg-white relative shadow-md sm:rounded-lg overflow-hidden ">
            <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
              <div class="w-full md:w-1/2">
                <form class="flex items-center">
                  ...
                  <div class="relative w-full">
                    ...
                    <input type="text" id="simple-search" class="bg-[#459E66] border-white text-white text-sm rounded-lg block w-full pl-10 p-2 border-none" placeholder="Search" required="" />
                  </div>
                </form>
              </div>
              <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                ...
                <div class="flex items-center space-x-3 w-full md:w-auto">
                  <button id="actionsDropdownButton" data-dropdown-toggle="actionsDropdown" class="w-full md:w-auto flex items-center justify-center py-2 px-4 text-sm font-medium text-white focus:outline-none bg-[#459E66] rounded-lg border border-gray-200 hover:bg-[#459E66] hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-200" type="button">
                  ...
                  <button id="filterDropdownButton" data-dropdown-toggle="filterDropdown" class="w-full md:w-auto flex items-center justify-center py-2 px-4 text-sm font-medium text-white focus:outline-none bg-[#459E66] rounded-lg border border-gray-200 hover:bg-{#459E66] hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-200 " type="button">
            ...
            <div class="overflow-x-auto">
              <table class="w-full text-sm text-left text-white">
                <thead class="text-xs text-white uppercase bg-gray-50 dark:bg-[#459E66]">
                  <tr>
                ...
                <tbody>
                  <tr class="border-b dark:border-gray-700 text-black">
                    <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap ">001</th>
                    <td class="px-4 py-3">Vaca</td>
                    <td class="px-4 py-3">Angus</td>
                    <td class="px-4 py-3 max-w-[12rem] truncate">Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit nam, recusandae tempora nesciunt harum labore corporis rem odit error dignissimos minus hic ipsam repellendus dolorum doloremque, vel quo obcaecati provident.</td>
                    <td class="px-4 py-3">10 años</td>
                    <td class="px-4 py-3 flex items-center justify-end">
                      <button id="apple-imac-27-dropdown-button" data-dropdown-toggle="apple-imac-27-dropdown" class="inline-flex items-center text-sm font-medium hover:bg-gray-100 dark:hover:bg-[#459E66] p-1.5 dark:hover-bg-gray-800 text-center text-gray-500 hover:text-white rounded-lg focus:outline-none " type="button">
                  ...
                  <tr class="border-b dark:border-gray-700 text-black">
                    <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap ">002</th>
                    <td class="px-4 py-3">Oveja</td>
                    <td class="px-4 py-3">Merina</td>
                    <td class="px-4 py-3 max-w-[12rem] truncate">Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit nam, recusandae tempora nesciunt harum labore corporis rem odit error dignissimos minus hic ipsam repellendus dolorum doloremque, vel quo obcaecati provident.</td>
                    <td class="px-4 py-3">5 años</td>
                    <td class="px-4 py-3 flex items-center justify-end">
                      <button id="apple-imac-20-dropdown-button" data-dropdown-toggle="apple-imac-20-dropdown" class="inline-flex items-center text-sm font-medium hover:bg-gray-100 dark:hover:bg-[#459E66] p-1.5 dark:hover-bg-gray-800 text-center text-black hover:text-white rounded-lg focus:outline-none dark:text-gray-400 dark:hover:text-gray-100" type="button">
                        <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                          <path d="M6 10a2 2 0 11-4 0 2 2 0 014 0zM12 10a2 2 0 11-4 0 2 2 0 014 0zM16 12a2 2 0 100-4 2 2 0 000 4z" />
                        </svg>
                      </button>
                  ...
                  <tr class="border-b dark:border-gray-700 text-black">
                    <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap ">003</th>
                    <td class="px-4 py-3">Vaca</td>
                    <td class="px-4 py-3">Holstein</td>
                    <td class="px-4 py-3 max-w-[12rem] truncate">Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit nam, recusandae tempora nesciunt harum labore corporis rem odit error dignissimos minus hic ipsam repellendus dolorum doloremque, vel quo obcaecati provident.</td>
                    <td class="px-4 py-3">5 años</td>
                    <td class="px-4 py-3 flex items-center justify-end">
                      <button id="apple-iphone-14-dropdown-button" data-dropdown-toggle="apple-iphone-14-dropdown" class="inline-flex items-center text-sm font-medium hover:bg-gray-100 dark:hover:bg-[#459E66] p-1.5 dark:hover-bg-gray-800 text-center text-gray-500 hover:text-white rounded-lg focus:outline-none dark:text-gray-400 dark:hover:text-gray-100" type="button">
                        <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                          <path d="M6 10a2 2 0 11-4 0 2 2 0 014 0zM12 10a2 2 0 11-4 0 2 2 0 014 0zM16 12a2 2 0 100-4 2 2 0 000 4z" />
                        </svg>
                      </button>
                  ...
                  <tr class="border-b dark:border-gray-700 text-black">
                    <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap ">004</th>
                    <td class="px-4 py-3">Caballo</td>
                    <td class="px-4 py-3">Pura sangre</td>
                    <td class="px-4 py-3 max-w-[12rem] truncate">Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit nam, recusandae tempora nesciunt harum labore corporis rem odit error dignissimos minus hic ipsam repellendus dolorum doloremque, vel quo obcaecati provident.</td>
                    <td class="px-4 py-3">7 años</td>
                    <td class="px-4 py-3 flex items-center justify-end">
                  ...
                  <tr class="border-b dark:border-gray-700 text-black">
                    <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap ">005</th>
                    <td class="px-4 py-3">Toro</td>
                    <td class="px-4 py-3">Brahman</td>
                    <td class="px-4 py-3 max-w-[12rem] truncate">Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugit nam, recusandae tempora nesciunt harum labore corporis rem odit error dignissimos minus hic ipsam repellendus dolorum doloremque, vel quo obcaecati provident.</td>
                    <td class="px-4 py-3">3 años</td>
                    <td class="px-4 py-3 flex items-center justify-end">
            ...
            <nav class="flex flex-col md:flex-row justify-between items-start md:items-center space-y-3 md:space-y-0 p-4" aria-label="Table navigation">
              ...
              <ul class="inline-flex items-stretch -space-x-px">
                <li>
                  <a href="#" class="flex items-center justify-center h-full py-1.5 px-3 ml-0 text-white bg-[#459E66] rounded-l-lg border border-[#459E66] hover:bg-[#459E66] hover:text-white">
                ...
                <li>
                  <a href="#" class="flex items-center justify-center h-full py-1.5 px-3 ml-0 text-white bg-[#459E66]  border border-[#459E66] hover:bg-[#459E66] hover:text-white">1</a>
                </li>
                <li>
                  <a href="#" class="flex items-center justify-center h-full py-1.5 px-3 ml-0 text-white bg-[#459E66]  border border-[#459E66] hover:bg-[#459E66] hover:text-white">2</a>
                </li>
                <li>
                  <a href="#" aria-current="page" class="flex items-center justify-center h-full py-1.5 px-3 ml-0 text-white bg-[#459E66]  border border-[#459E66] hover:bg-[#459E66] hover:text-white">3</a>
                </li>
                <li>
                  <a href="#" class="flex items-center justify-center h-full py-1.5 px-3 ml-0 text-white bg-[#459E66]  border border-[#459E66] hover:bg-[#459E66] hover:text-white">...</a>
                </li>
                <li>
                  <a href="#" class="flex items-center justify-center h-full py-1.5 px-3 ml-0 text-white bg-[#459E66]  border border-[#459E66] hover:bg-[#459E66] hover:text-white">100</a>
                </li>
                <li>
                  <a href="#" class="flex items-center justify-center h-full py-1.5 px-3 ml-0 text-white bg-[#459E66] rounded-r-lg border border-[#459E66] hover:bg-[#459E66] hover:text-white">
